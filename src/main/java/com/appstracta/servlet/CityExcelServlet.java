...
/**
 * Servlet implementation class CityExcelServlet
 */
@WebServlet("/city/excel")
public class CityExcelServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (PrintWriter out = response.getWriter()) {
			try {
				...
				resultado.put("datos", cityBo.obtenerExcel());
