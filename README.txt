...
a persistence unit "sakila-webPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sakila-web\pom.xml":
...
artifact ("sakila-web.war") is already built. You can build
